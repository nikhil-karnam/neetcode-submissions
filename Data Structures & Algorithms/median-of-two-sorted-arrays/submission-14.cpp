...
public:
    double findMedianSortedArrays(vector<int>& nums1, vector<int>& nums2) {
        ...
        /*given an element in A, we know how many are below it. we know the median length.
        we know how many in B are needed to make up median length. are those truly below the
